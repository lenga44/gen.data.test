...
public class Constant {
    public static final String ZIP_FOLDER_PATH = FileHelpers.getRootFolder()+"\\gen.data.test\\src\\main\\zipFile";
    public static final String UNZIP_FOLDER_PATH =FileHelpers.getRootFolder()+"\\gen.data.test\\src\\main\\unZipFile";
