...
public class Constant {
    ...
    public static final String GAME_AI_LIST = FileHelpers.getProjectPath()+"/src/main/java/ai/speak/course/data/list_game_ai.json";
    ...
    public static final List<String> splits1 = Arrays.asList("./ ","\\|", "\\;","/"," or ");
}
