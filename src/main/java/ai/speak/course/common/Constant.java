...
public class Constant {
    public static final String ZIP_FOLDER_PATH = FileHelpers.getProjectPath()+"/src/main/java/ai/speak/course/zipFile";
    public static final String UNZIP_FOLDER_PATH =FileHelpers.getProjectPath()+"/src/main/java/ai/speak/course/unZipFile";
